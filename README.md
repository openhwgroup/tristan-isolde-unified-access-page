...
ELinOS | To be released in spring 2024 [access on request](https://www.sysgo.com/elinos) | WI4.3.2 | SYSGO | Initial release | GPL |
PikeOS CVA-6 support | To be released | WI4.3.3 | SYSGO | Initial release | proprietary |  
